...
/* package mandelbrot-0.1.0.0 */
#ifndef VERSION_mandelbrot
#define VERSION_mandelbrot "0.1.0.0"
#endif /* VERSION_mandelbrot */
#ifndef MIN_VERSION_mandelbrot
#define MIN_VERSION_mandelbrot(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mandelbrot */
...
#define CURRENT_COMPONENT_ID "mandelbrot-0.1.0.0-inplace-mandelbrot"
